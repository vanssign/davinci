...
export function buildHTML(element, index) {
    ...
    if (tag == "h2") {
        ...
        return (
            <div key={tag + index} className={`col-${element.col} col-md-${element.colMd} col-lg-${element.colLg}`}><h2 className={allClasses}>{content}</h2>
            </div>)
    }
    if (tag == "p") {
        return (
            <div key={tag + index} className={`col-${element.col} col-md-${element.colMd} col-lg-${element.colLg}`}><p className={allClasses}>{content}</p></div>)
    }
    if (tag == "h3") {
        return (
            <div key={tag + index} className={`col-${element.col} col-md-${element.colMd} col-lg-${element.colLg}`}><h3 className={allClasses}>{content}</h3></div>)
    }
    if (tag == "img") {
        return (
            <div key={tag + index} className={`text-${element.alignment} py-3 col-${element.col} col-md-${element.colMd} col-lg-${element.colLg}`}>
    ...
    if (tag == "mediaText") {
        return (
            <div key={tag + index} className={`col-${element.col} col-md-${element.colMd} col-lg-${element.colLg}`}>
    ...
    if (tag == "h4") {
        return (
            <div key={tag + index} className={`col-${element.col} col-md-${element.colMd} col-lg-${element.colLg}`}><h4 className={allClasses}>{content}</h4></div>)
    }
    if (tag == "h5") {
        return (<div key={tag + index} className={`col-${element.col} col-md-${element.colMd} col-lg-${element.colLg}`}><h5 className={allClasses}>{content}</h5></div>)
    }
    if (tag == "h6") {
        return (<div key={tag + index} className={`col-${element.col} col-md-${element.colMd} col-lg-${element.colLg}`}><h6 className={allClasses}>{content}</h6></div>)
    }
    if (tag == "ul") {
        return (
            <div key={tag + index} className={`col-${element.col} col-md-${element.colMd} col-lg-${element.colLg}`}>
    ...
    if (tag == "button") {
        return (
            <div className={`text-${element.alignment} col-${element.col} col-md-${element.colMd} col-lg-${element.colLg}`}>
    ...
    if (tag == "code") {
        return (<div key={tag + index} className={`col-${element.col} col-md-${element.colMd} col-lg-${element.colLg}`}><code className={allClasses} style={{ whiteSpace: 'pre-wrap' }}>{content}</code></div>)
    }
    if (tag == "blockquote") {
        return (<div key={tag + index} className={`col-${element.col} col-md-${element.colMd} col-lg-${element.colLg}`}><blockquote className={allClasses} cite={element.cite}>{content}</blockquote></div>)
    }
    if (tag == "hr") {
        return (
            <hr />
